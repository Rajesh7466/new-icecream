...
function showEditAddressModal(address, addressType, isDefault) {
    ...
    saveBtn.addEventListener('click', async function() {
        ...
        try {
            ...
            const response = await fetch(` https://icecream-store-backend.onrender.com/adress/update/${address.id}`, {
                method: 'PUT',
                headers: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (changePasswordForm) {
        changePasswordForm.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch(` https://icecream-store-backend.onrender.com/user/change/password/${userEmail}`, {
